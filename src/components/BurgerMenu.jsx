...
function BurgerMenu() {
  ...
  const menuItems = [
    { label: 'Report Bug / Feedback', href: 'https://github.com/cgiovando/oam-vibe/issues', icon: 'bug' },
    { label: 'AI Disclaimer', href: 'https://github.com/cgiovando/oam-vibe#ai-generated-code-disclaimer', icon: 'info' },
    { label: 'GitHub Repository', href: 'https://github.com/cgiovando/oam-vibe', icon: 'github' },
    { type: 'divider' },
        ...
        <div className="absolute top-12 right-0 w-56 bg-white rounded-lg shadow-xl border border-gray-100 overflow-hidden animate-fade-in origin-top-right">
          ...
          <div className="px-4 py-2 bg-amber-50 border-t border-amber-100">
            <p className="text-xs text-amber-700">
              ...
              <a href="https://github.com/cgiovando/oam-vibe#ai-generated-code-disclaimer" target="_blank" rel="noreferrer" className="underline ml-1">Learn more</a>
            </p>
          </div>
        </div>
      )}
